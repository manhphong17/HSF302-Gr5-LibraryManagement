...
-- 8. INSERT BOOKS
INSERT INTO books (book_id, title, stock_quantity, category_id) VALUES
(1, 'Clean Code', 5, 1),
(2, 'Effective Java', 3, 1),
(3, 'Refactoring', 4, 1),
(4, 'Domain-Driven Design', 2, 1),
(5, 'Truyện Kiều', 10, 3),
(6, 'Lịch Sử Việt Nam', 8, 5);
